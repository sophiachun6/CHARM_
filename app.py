        ...
        for c in obs["component"]:
            ...
            if code == "chills":
                ...
                if value is not None:
                    defaults["anemia"] = "Yes" if value < 4 else "No"
                ...
                if value is not None:
                    defaults["rdw"] = "Yes" if value > 14.5 else "No"
                ...
                if value is not None:
                    defaults["hypothermia"] = "Yes" if value < 36 else "No"
